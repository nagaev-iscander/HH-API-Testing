# проверка, что вакансии находятся, сочетание русских и английских слов
...
log_name="test_1.3.log"

URL="https://api.hh.ru/vacancies/"
HEADERS = {'User-Agent': 'HomeTask testing'}
text_data="программист JAVA"
...
if(response.status_code!=STATUS_200_OK):
    ...
    f.write("Vacancies found=" + int(response.json()['found']) + '\n')
    print("NOT OK")
else:
    f.write("OK\n");
    print("OK")
