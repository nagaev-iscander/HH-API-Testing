# использование большого количества логических операторов

import requests

STATUS_200_OK=200
CONTENT_TYPE_ANSWER="application/json; charset=UTF-8"
log_name="test_5.1.log"

URL="https://api.hh.ru/vacancies/"
HEADERS = {'User-Agent': 'HomeTask testing'}
text_data="(Программист OR массажист OR псих*) AND менеджер NOT лимфо* NOT салон NOT Программист NOT психолог"
